...
# -*- coding: utf-8 -*-
# @Time    : 2023/4/17
# @Author  : thoughts.times@gmail.com
# @File    : shipsear.py
...
class Shipsear(BaseImageDataset):
    """
    Shipsear
    """
    dataset_dir = ''
    ...
    def __init__(self,
                 root_train='./datasets/reid_datasets/Corrected_Market1501',
                 root_val='./datasets/reid_datasets/Corrected_Market1501',
                 pid_begin=0,
                 verbose=True,
                 **kwargs):
        super(Shipsear, self).__init__()
